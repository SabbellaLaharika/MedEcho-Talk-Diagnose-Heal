            ...
            >
              <div>
                ...
                <p className="text-base sm:text-lg font-bold text-slate-800 mt-6 leading-relaxed">
                  <TranslatedText text={latestReport.diagnosis} targetLang={user.preferredLanguage} />
                </p>
              ...
              <div className="flex items-center justify-between mt-10 pt-6 border-t border-slate-200">
                <span className="text-[11px] font-black text-slate-700 uppercase">
                  <TranslatedText text={latestReport.doctorName} targetLang={user.preferredLanguage} />
                </span>
