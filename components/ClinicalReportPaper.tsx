  ...
  return (
    <div id={`printable-area${idSuffix}`} className="bg-white mx-auto w-full max-w-[210mm] min-h-[297mm] shadow-lg p-8 sm:p-[20mm] border border-slate-100 font-serif text-slate-900">
      ...
      <div className="flex justify-between items-start border-b-2 border-slate-900 pb-8 mb-10">
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase mb-1">MedEcho</h1>
      ...
      <div className="grid grid-cols-2 gap-10 mb-12">
        <div>
          <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2">Subject Information</h5>
        ...
        <div className="text-right">
          <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2">Examination Date</h5>
        ...
        <div className="grid grid-cols-3 gap-6 mb-12 no-print">
          ...
          {report.vitals.weight && (
            <div className="bg-blue-50 p-6 rounded-[2rem] border border-blue-100 flex flex-col items-center text-center shadow-sm">
              ...
              <p className="text-[9px] font-black text-blue-400 uppercase tracking-widest leading-none mb-1">Weight</p>
      ...
      <div className="mb-12">
        <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Diagnostic Result</h5>
        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 flex items-center justify-between">
          <div>
            <p className="text-[10px] font-black text-blue-500 uppercase tracking-widest mb-1">Predicted Condition</p>
            <h2 className="text-3xl font-black text-slate-900">{report.diagnosis}</h2>
          </div>
          <div className="text-right">
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Confidence Factor</p>
      ...
      <div className="grid grid-cols-2 gap-10 mb-12 items-start">
        <section>
          <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Reported Parameters</h5>
        ...
        <section>
          <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Anamnesis Details</h5>
      ...
      <div className="mb-12">
        <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Advice & Management Plan</h5>
