  ...
  return (
    <div className="p-4 sm:p-8 max-w-[1400px] mx-auto h-[calc(100vh-100px)] flex flex-col space-y-6">
      <div className="flex-shrink-0">
        <h2 className="text-2xl font-black text-slate-800 tracking-tight uppercase">Medical Reports</h2>
            ...
            {filteredReports.map((report) => (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-sm font-black text-slate-800 uppercase tracking-tight">{report.diagnosis}</h3>
          ...
          {activeReport ? (
            <>
              ...
              <div className="p-8 border-b border-slate-50 flex justify-between items-center">
                <h2 className="text-lg font-black text-slate-800 uppercase tracking-tight">Diagnosis Report</h2>
              ...
              <div className="flex-1 overflow-y-auto p-10 space-y-10 custom-scrollbar">
                {/* Predicted Condition */}
                <section>
                  <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Predicted Condition</h4>
                  <div className="flex items-center space-x-6">
                    <div className="p-4 bg-slate-50 rounded-2xl text-slate-800 animate-pulse border border-slate-100">
                      <HeartIcon className="w-8 h-8" />
                    </div>
                    <div className="flex items-center space-x-4">
                      <h3 className="text-4xl font-black text-slate-900 tracking-tight">{activeReport.diagnosis}</h3>
                ...
                {/* Reported Symptoms */}
                <section>
                  <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Reported Symptoms</h4>
                ...
                {/* Patient History */}
                <section>
                  <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Patient History (Q&A)</h4>
                ...
                {activeReport.prescription && activeReport.prescription.length > 0 && (
                   <section>
                    <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Advice & Precautions</h4>
