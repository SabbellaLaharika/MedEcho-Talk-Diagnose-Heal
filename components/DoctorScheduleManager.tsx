...
const DoctorScheduleManager: React.FC<DoctorScheduleManagerProps> = ({ doctor }) => {
  ...
  // Bulk set state - now a list of slots to apply
    ...
    <div className="p-4 sm:p-10 max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          disabled={saving}
          className={`px-8 py-4 rounded-2xl font-black uppercase text-[10px] tracking-widest transition-all flex items-center gap-2 ${
